...
- next relevance step: after alpha.5.34 real-Windows validation, move to intent-stable usage ranking so usage may reorder candidates only inside equivalent relevance/surface intent rather than overpowering stronger lexical intent
