...
- v0.8.0-alpha.5.22 separates expensive AppsFolder classification from lightweight 5-second change fingerprinting so smarter catalog admission does not add unnecessary idle Shell/COM work
