...
- next relevance step: validate alpha.5.37 on real utility folders; do not invent vocabulary for any remaining opaque entries, and move to intent-stable usage ranking once generic catalog evidence is exhausted
