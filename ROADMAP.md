...
- next relevance step: validate alpha.5.38 on real opaque suite entries; if generic catalog admission is clean, move to intent-stable usage ranking instead of adding product vocabulary
