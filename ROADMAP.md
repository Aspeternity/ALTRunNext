...
- next Intelligent Launch Catalog step: validate alpha.5.31 on real suites; after Catalog role coverage is stable, treat short-query precision/system-surface noise as a separate relevance problem rather than mixing it into role suppression
