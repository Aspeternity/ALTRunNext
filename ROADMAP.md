...
- v0.8.0-alpha.3.8 follows with Shortcut Editor visual consolidation without changing Runtime Input / Path Conversion / Advanced Options semantics
- v0.8.0-alpha.3.9 is reserved for final real-Windows Shortcut workflow polish plus Path Conversion visual integration only
