...
- next Intelligent Launch Catalog step: validate alpha.5.29/alpha.5.30 together on real suites after the repaired rolling updater delivers the build, then classify only remaining genuinely ambiguous companion/diagnostic/synchronization entries from generic evidence rather than product-name exceptions
